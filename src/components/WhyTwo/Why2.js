        ...
        <>
            <section className='backgroundOne'>
                <Container  maxWidth={'lg'}>
                    <Grid container rowGap={{ xs: 3, md: 6 }} direction={{ xs: 'row', sm: 'row', md: 'row', lg: 'row', xl: 'row', }} sx={{ zIndex: 1, position: 'relative', paddingTop: { xs: 3, md: 5, }, paddingBottom: { xs: 3, md: 5, }, }} >
