...
function ResponsiveAppBar() {
  ...
  return (
    <AppBar className={`${style.navbar} website_header`} position="sticky">
        ...
        <>
          {authToken ? (
            <Toolbar disableGutters>
              ...
              <Box sx={{ gap:{sm:2,md:2,lg:3},flexGrow: 0, display: {  md: "flex" } }}>
              <span
                  style={{ marginBottom: "0px", color: "var(--orange)",alignSelf: "center" }}
                >{user}</span>
                <Link to={"Login"}>
                  <button
