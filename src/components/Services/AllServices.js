    ...
    return (
        <section className='backgroundTwo'>
            <Container maxWidth={'lg'}>
                <Grid sx={{ zIndex: '1', position: 'relative', paddingTop: { xs: 3, md: 5,lg:7   }, paddingBottom: { xs: 3, md: 5,lg:6 }, }} container >
                    ...
                    <Grid rowSpacing={5} columnSpacing={5} container>
                        <Grid item xs={12} sm={12} md={6} lg={6} xl={6}>
                            <div className="serCard1">
                                ...
                                <h3>Emergency car towing service</h3>
                                <p>We are a well-equipped towing service available to help with towing a car 24/7 we provide a fast, affordable, friendly, and reliable   </p>
                            </div>
                        </Grid>
                        <Grid item xs={12} sm={12} md={6} lg={6} xl={6} >
